...
public class Prestito {
    ...
    public Prestito(int id, String titoloLibro, String isbn, Date dataInizio, Date dataScadenza, Date dataRestituzione, int renewalCount) {
        this.id = id;
    ...
    public Date getDataRestituzione() { return dataRestituzione; }
