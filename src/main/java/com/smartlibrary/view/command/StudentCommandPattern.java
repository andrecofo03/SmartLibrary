...
public class StudentCommandPattern {
    ...
    public SearchCommand(ValidatedReader input, StudentLoanController controller, CourseDAO courseDAO, Map<Integer, String> corsiMap) {
            this.input = input;
        ...
        @Override
        public String getDescription() { return "Visualizza Libri Disponibili"; }
    ...
    public static class LoanCommand implements Command {
        ...
        @Override
        public String getDescription() { return "Richiedi prestito / Scarica ebook"; }
    ...
    public static class ReturnCommand implements Command {
        ...
        @Override
        public String getDescription() { return "Restituisci libro"; }
    ...
    public static class HistoryCommand implements Command {
        ...
        @Override
        public String getDescription() { return "Il tuo storico prestiti"; }
        ...
        public void execute() {
            ...
            for (Prestito p : storico) {
                ...
                System.out.printf("%-15s %-30s %-12s %-12s %-10s\n",
                    p.getIsbn(),
                    (p.getTitoloLibro().length() > 28 ? p.getTitoloLibro().substring(0,25)+"..." : p.getTitoloLibro()),
                    p.getDataInizio(),
                    p.getDataScadenza(),
                    stato
                );
